...
class ProcurementCategoryController extends Controller
{
    ...
    {
//        $this->middleware(['permission:list_procurement_categories'])->only(['index', 'getAllIds']);
//        $this->middleware(['permission:create_procurement_categories'])->only('store');
//        $this->middleware(['permission:update_procurement_categories'])->only(['update', 'toggleActiveStatus']);
